...
/**
 * from io.jsonwebtoken.impl.DefaultJwtParser
 * I need to parse header and payload before the signature of the token is validated
 */
public class JwtTokenParser implements JwtParser {
    ...
    public Jwt parse(String jwt) throws ExpiredJwtException, MalformedJwtException, SignatureException {
        ...
        // Ike, 2019-11-20, do not validate the signature
